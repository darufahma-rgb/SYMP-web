...
export default function MeetTheDesigner() {
  ...
  // Fungsi untuk scroll ke bawah sejauh satu layar (100vh)
  const handleScrollDown = () => {
    window.scrollBy({
      top: window.innerHeight, // Scroll ke bawah sejauh tinggi layar
      behavior: 'smooth'       // Efek gerak halus
    });
  };
            ...
            <div className="hidden md:block">
              ...
              <div className="flex justify-start mt-8">
                  <button 
                    ...
                    className="w-20 h-20 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition shadow-[0_0_20px_rgba(255,255,255,0.2)] group text-[#8A0202] cursor-pointer"
                  >
          ...
          <div className="order-3 md:hidden text-center space-y-6">
             <p className="text-white/80 text-sm leading-relaxed max-w-xs mx-auto font-light">
              ...
              <div className="flex justify-center">
                  <button 
                    onClick={handleScrollDown}
                    className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.2)] text-[#8A0202] cursor-pointer"
                  >
